 ...
 *
 * The emitted payload follows the Store Manager `order.created` schema: minor →
 * major decimal price strings, a name split, and the ConvesioPay shipping-shape
 * mapping.
 *
...
const SOURCE = 'checkout-funnel-clinical';
